                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                        ...
                        <?php
                            ...
                            AND customers.companyId=offices.companyId AND offices.id = customers.offId AND offices.status='Rent' AND reserveStatus='Approved' ORDER BY customers.id DESC") or die(mysqli_error($conn));
