      ...
      <div class="main-content">
        <section class="section">
          <div class="section-body">
            <?php
              $qs = mysqli_query($conn,"SELECT *FROM customers WHERE reserveStatus = 'Approved'");
                      ...
                      <div class="row ">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                          <div class="card-content">
                            ...
                            <?php
                              $findRev = mysqli_query($conn,"SELECT SUM(offices.price) as summation FROM offices,customers WHERE offices.id = customers.id") or die(mysqli_error($conn));
